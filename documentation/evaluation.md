...
D05 permits original-question retrieval after a logged rewrite failure. Retain completed fallback trials in end-to-end results and report fallback frequency and quality separately from successful original-plus-rewritten trials. A recovered rewrite error is not automatically a failed answer or a secure response. Report retrieval mode and rewrite outcome alongside final completion status; disclose fallback differences between experimental conditions.
